...
<form method="post" action="<?php echo base_url(); ?>master/barang/simpan" class="form-horizontal" id="forminputbe"
  >
  ...
  <div class="form-group">
    ...
    <div class="col-sm-4">
      <input required type="text" class="form-control" name="barang">
    </div>
   <label class="col-sm-2 control-label">Harga</label>
    <div class="col-sm-4">
      <input required type="text" class="form-control" name="harga" id="currencybe">
    </div>
  </div>
  <div class="form-group">
