  ...
  <div class="content-wrapper">
    ...
    <a title="view Data"  href="<?php echo base_url(); ?>adminb3/history_request_job/" class='btn btn-success btn-sm btn-flat'> <i class='fa fa-eye'></i> View Data</a> 
    </section>
...
<div class="tabbable tabs-left">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-2">
      <input  type="text" class="form-control" readonly value="<?php echo $st [$view_lamar->status]?>">
    </div>
    <label class="col-sm-2 control-label">Alasan </label>
    <div class="col-sm-6">
      <input  type="text" class="form-control" readonly value="<?php echo $view_lamar->alasan?>">
    </div>
  </div>
</form>
