...
<form method="post" action="<?php echo base_url(); ?>master/k_barang/simpan" class="form-horizontal">
    ...
    <div class="col-sm-4">
      <input required type="text" class="form-control" name="kdk_barang">
    </div>
  </div>
  <div class="form-group">
    <label class="col-sm-2 control-label">Jenis Barang</label>
    <div class="col-sm-4">
      <input required type="text" class="form-control" name="k_barang">
    </div>
  </div>
  <div class="form-group">
