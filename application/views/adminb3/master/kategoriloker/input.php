...
<form method="post" action="<?php echo base_url(); ?>adminb3/kategoriloker/simpan" class="form-horizontal">
  
  <div class="form-group">
    <label class="col-sm-2 control-label"> kategori loker</label>
    <div class="col-sm-4">
      <input required type="text" class="form-control" name="kategoriloker">
    </div>
  </div>
