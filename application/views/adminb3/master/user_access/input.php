...
<form method="post" action="<?php echo base_url(); ?>adminb3/user_access/simpan" class="form-horizontal">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-4">
       <select name="id_menu" required class="select2 " style="width: 100%;">
           <option value="">--pilih--</option>
           
                    <?php
                  foreach($dt_menu->result_array() as $sp)
                  {
                  ?>
                  <option value="<?php echo $sp['id_menu']; ?>"><?php echo $sp['menu_name']; ?></option>
                <?php
                  }
                  ?>
            </select>
